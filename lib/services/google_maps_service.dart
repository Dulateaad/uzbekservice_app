...
class GoogleMapsService {
  ...
  static Future<dynamic> createMap({
    ...
    try {
      ...
      final google = js_util.getProperty(js.context, 'google');
      if (google == null) {
      ...
      final map = js_util.callConstructor(mapConstructor, [container, mapOptions]);
  ...
  static dynamic addMarker({
    ...
    try {
      ...
      final marker = js_util.callConstructor(markerConstructor, [markerOptions]);
